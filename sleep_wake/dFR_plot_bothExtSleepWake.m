...
% Run both extwake and extsleep analysis

%load in workspaces from diff analyses
% 
% cont_wake_ws = load("\\files.brandeis.edu\turrigiano-lab\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\ContCell_MasterStrct_v3_DL78pred_extwake_WS.mat");
% cont_sleep_ws = load("\\files.brandeis.edu\turrigiano-lab\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\ContCell_MasterStrct_v3_DL78pred_extsleep_WS.mat");
% hunt_wake_ws = load("\\files.brandeis.edu\turrigiano-lab\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\MasterStrct_StableBase_Hr66_withStates_v4_DL44predlab_extwake_WS.mat");
% hunt_sleep_ws = load("\\files.brandeis.edu\turrigiano-lab\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\MasterStrct_StableBase_Hr66_withStates_v4_DL44predlab_extsleep_WS.mat");
...
% RSU meant4
cont_wake_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\ContCell_MasterStrct_v3_DL78pred_extwake_WS.mat");
cont_sleep_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\ContCell_MasterStrct_v3_DL78pred_extsleep_WS.mat");
hunt_wake_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\MasterStrct_StableBase_Hr66_withStates_v8_BL71incl_extwake_WS_meant4.mat");
hunt_sleep_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\MasterStrct_StableBase_Hr66_withStates_v8_BL71incl_extsleep_WS_meant4.mat");

% FS meant4
hunt_wake_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\pFSStableBase_Hr66_extwake_WS_meant4_FS.mat");
hunt_sleep_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\pFSStableBase_Hr66_extsleep_WS_meant4_FS.mat");

% FS meant6
hunt_wake_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\pFSStableBase_Hr66_extwake_WS_meant6_FS.mat");
hunt_sleep_ws = load("Z:\BrianCary\CODE\Dan_SW_FR_analysis\Dan_version_ofAlejCode\stored_data\extwakesleep\pFSStableBase_Hr66_extsleep_WS_meant6_FS.mat");
...
% table_dat = padmat(AW_delta_nonan,QW_delta_nonan,2);
% table_dat = padmat(table_dat,NREM_delta_nonan,2);
% 
% [p,tbl,stats] = anova1(table_dat);
% 
% % tests specific pairs
% results = multcompare(stats); % defaults to tukey-kramer critical value
