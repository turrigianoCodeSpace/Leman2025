...
savename = [char(sp_path2{1}),'_extsleep_WS_meant6.mat'];
...
% 
%     figure;
%     hist(sleep_props,0:0.05:1);
%     ylabel('count')
%     xlabel('Sleep proportions')
%     title(['Ext. sleep - sleep props -- anim: ',animal])
%     box off
...
% delta_nonans_NREM = ~isnan(cat_NREM_deltas);
% num_REM_nonan = cat_REM_num(delta_nonans_REM);
